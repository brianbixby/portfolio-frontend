      ...
      <div className='pageContent'>
        <div className='aboutHeader'>
          <div className='container'>
            <p> Hello, I’m a Front End Software Engineer in Seattle, WA. Over the last year I've had the pleasure of honing my skillset through an immersive software engineering program at 42 Silicon Valley, previously I crafted digital experiences at John L. Scott. </p>
          </div>
        </div>
